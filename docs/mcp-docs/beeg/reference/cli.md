---
title: "CLI — Beeg API"
summary: "Documents the command-line interface, arguments, and examples for the Beeg API."
...
Documents the command-line interface, arguments, and examples for the Beeg API.

## beeg_api

`beeg_api` can be executed as a console command or via `python -m beeg_api`:

```bash
# Download a single video
beeg_api --download "https://beeg.com/1234567" --quality best --output ./downloads --no-title False

# Or invoke via python -m
python -m beeg_api --download "https://beeg.com/1234567" --quality best --output ./downloads --no-title False

# Download from a line-separated text file of URLs
beeg_api --file urls.txt --quality best --output ./downloads --no-title False
```
