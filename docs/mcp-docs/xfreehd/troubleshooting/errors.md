---
title: "Errors and troubleshooting — XFreeHD API"
summary: "Identifies documented XFreeHD API errors, their meanings, and the safe handling behavior."
public_url: "https://docs.echteralsfake.me/xfreehd/"
aliases:
  - "XFreeHD Errors and troubleshooting"
keywords:
  - "XFreeHD"
...
# Errors and troubleshooting — XFreeHD API

Identifies documented XFreeHD API errors, their meanings, and the safe handling behavior.
...
from xfreehd_api.modules.errors import NotFound, BotDetection
