---
title: "Iteration and ScrapeResult — xHamster API"
summary: "Documents Iteration and ScrapeResult behavior, signatures, fields, constraints, and examples for the xHamster API."
public_url: "https://docs.echteralsfake.me/xhamster/"
aliases:
  - "xHamster Iteration and ScrapeResult"
keywords:
  - "xHamster"
...
async for result in client.search_videos(
    "reality", pages=2, iterator_config=iterator_config
):
    if result.succeeded:
        video = result.unwrap()
        print(video.title)
...
Type: Video | Short | None; Description: The loaded item on success
...
Type: Video | Short; Description: Returns the item or raises its terminal error
